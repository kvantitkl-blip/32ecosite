;(function () {
  ...
  let dirtyPlaces = [
    { name: 'Бежицкий р-н г. Брянска', coords: [53.2900, 34.2900], severity: 'высокая', pollutant: 'PM10, NO₂' },
  ...
  const emittersBase = [
    ...
    { name: 'Брянский цементный завод ', percent: 2 },
    { name: 'Клинцовский комбинат стройматериалов ', percent: 2 },
    { name: 'Брянский теплоэнергетический узел ', percent: 1 },
    { name: 'Брянский завод металлоконструкций ', percent: 1 },
    { name: 'Новозыбковский перерабатывающий комплекс ', percent: 1 }
  ]
